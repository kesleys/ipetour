...
export default function MainHomeTurismoTropical() {
  return (
    <div className="main_home_turismo_tropical">
      <div className="imagem_main_home_turismo_tropical"></div>
      <div className="texto_main_home_turismo_tropical">
        ...
        <a id="saiba_maismain_home_turismo_tropical" href="/">saiba mais</a>
      </div>
      <img
        src="src\assets\icon-flor-laranja-roxo-azul.png"
